import yaml
from AgentLayer.ConventionalAgents.RFAgent import RFAgent
...
if __name__ == '__main__':
    ...
    # create agent
    rf = RFAgent(**policy_params["RF_PARAMS"])
    ...
    #load model
    rf_loaded = rf.load_model("AgentLayer/ConventionalAgents/rf_model")
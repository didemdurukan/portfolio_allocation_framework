import yaml
from AgentLayer.ConventionalAgents.HRAgent import HRAgent
...
if __name__ == '__main__':
    ...
    # create agent
    hr = HRAgent(**policy_params["HR_PARAMS"])
    ...
    # load model
    hr_loaded = hr.load_model("AgentLayer/ConventionalAgents/hr_model")
